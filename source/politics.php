...
<body class="page-body page-body--politics container">
    ...
    Smart Trade, номер компании 2020-00035, зарегистрирована по адресу Rodney Bayside, Rodney Bay, Gros-Islet, Сент-Люсия («Компания»; «мы»; «мы»; «наши») и ее филиалы уважают вашу конфиденциальность и ценят ее важность и полностью привержены обеспечению безопасности и защиты вашей информации.

    Настоящая Политика конфиденциальности вместе с нашим Клиентским соглашением регулирует сбор, обработку и использование вашей Личной информации Компанией и применяется всякий раз, когда вы посещаете или используете наш веб-сайт или любые другие предоставляемые нами онлайн-услуги («Услуги»).
    ...
    Если вы хотите воспользоваться какими-либо правами, изложенными выше, свяжитесь с нами. Плата обычно не взимается. Вам не нужно будет вносить оплату за доступ к вашим Персональным данным (или для осуществления любых других прав). Однако мы можем взимать разумную плату, если ваш запрос явно необоснованный, повторяющийся или чрезмерный.
    ...
    Однако мы будем признательны за возможность разобраться с вашими проблемами до того, как вы обратитесь в контролирующий орган, поэтому, пожалуйста, сначала свяжитесь с нами.
    <ol start="9">
    ...
    Полное наименование юридического лица: Smart Trade<br>

    Адрес электронной почты: google@finance.com<br>

    Почтовый адрес: Родни Бэйсайд Билдинг, Родни Бэй, Грос-Айлет, Сент-Люсия<br>

    Пожалуйста, используйте слова «Защита данных» в строке темы.
    </div>
    <footer class="page-footer page-footer--politics container">
        ...
        <div class="page-footer__wrapper">
            <a class="active" href="<?= $path; ?>politics.php" class="page-footer__polycy">Политика конфиденциальности</a>
            <a href="<?= $path; ?>conditions.php" class="page-footer__polycy">Пользовательское соглашение</a>
        </div>
    </footer>
