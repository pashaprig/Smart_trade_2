...
<head>
  ...
  <meta
    name="Бесплатное обучение и практическое сопровождении на реальном торговом счете. Стань профитным трейдером в течении 7 дней"
    content="Title" />
    <link rel="stylesheet" href="<?= $path; ?>/css/style.min.css">
    <!-- https://realfavicongenerator.net/ -->
    <link rel="apple-touch-icon" sizes="72x72" href="<?= $path; ?>/img/favicon/apple-touch-icon.png">
...
<body class="page-body page-body--politics container">
    <header class="page-header ">
    <a href="<?= $path; ?>index.php">
        <svg width="98" height="67">
            <use xlink:href="<?= $path; ?>/img/sprite.svg#logo"></use>
        </svg>
    </a>
        <nav class="main-nav main-nav--closed main-nav--nojs">
            <ul class="main-nav__list">
                <li class="main-nav__item main-nav__item--shadow"></li>
                <li class="main-nav__item"><a href="<?= $path; ?>index.php#video">Презентация</a></li>
                <li class="main-nav__item"><a href="<?= $path; ?>index.php#partners">Партнёры</a></li>
                <li class="main-nav__item"><a href="<?= $path; ?>index.php#about">О проекте</a></li>
                <li class="main-nav__item"><a href="<?= $path; ?>index.php#investment">Инвестирование</a></li>
            </ul><a class="btn" href="<?= $path; ?>index.php#leadform1">Зарегистрироваться</a> <button class="main-nav__toggle" type="button"><span class="main-nav__open-btn-text visually-hidden">Mеню</span></button>
        </nav>
    </header>
    <hr>
    <div class="legal-content">
        ...
        <b>ПОЖАЛУЙСТА, ВНИМАТЕЛЬНО ПРОЧИТАЙТЕ НАСТОЯЩЕЕ КЛИЕНТСКОЕ СОГЛАШЕНИЕ, ПРЕЖДЕ ЧЕМ ИСПОЛЬЗОВАТЬ САЙТ ИЛИ ЛЮБЫЕ УСЛУГИ, ПРЕДЛАГАЕМЫЕ ЧЕРЕЗ ВЕБ-САЙТ.</b>



        <p>Настоящее Клиентское соглашение (в дальнейшем именуемое «Соглашение») заключается между вами и Smart Trade, компания с номером 2020-00035, зарегистрированным домом Rodney Bayside, Rodney Bay, Gros-Islet, Сент-Люсия, частной компанией с ограниченной ответственностью, созданной и существующей в соответствии с законами Сент-Люсии («Компания», «мы» или «нас»).</p>

        <p>Настоящее Соглашение регулирует использование услуг, предоставляемых через Веб-сайт Smart Trade (далее именуемый «Веб-сайт»), которым управляет Smart Trade («Услуги» или «Сервис»).</p>
        ...
        <b>Ненормальные рыночные условия</b>
        <p> - это условия, когда на рынке низкая ликвидность, быстрое движение цен на рынке или разрыв цен.</p>
        ...
        <p><b>Компания</b> - Smart Trade (зарегистрированный номер: 2020-00035), Родни Бэйсайд Билдинг, Родни Бэй, Грос-Айлет, Сент-Люсия.</p>
        ...
        <p>3.13 Клиент понимает, подтверждает и принимает здесь, что любая и / или вся его / ее история торговли в Платформах Web Trader и / или Smart TradeTrader 5 может быть в любое время и без предварительного письменного согласия и / или уведомления Клиента, в дальнейшем, заархивирована Компанией в одну итоговую строку в соответствующем торговом счете Web Trader и / или Smart TradeTrader 5, где такие записи истории торговли превышают один (1) месяц.</p>
        ...
        <p>5.5 Клиент несет единоличную ответственность за подачу налоговых деклараций и отчетов</p>
        <p>по любой Торговой операции, которые должны быть сделаны любому соответствующему органу власти, государственному или иному, и за уплату всех налогов (включая, но не ограничиваясь перечислением, передачей&nbsp; добавленной стоимости), возникающие из или в связи с любой Торговой операцией.</p>
        ...
        <p>10.2 Компания принимает претензии, возникающие по настоящему Соглашению, только по электронной почте hello@google-finance.support и не позднее семи рабочих дней с даты (дня) оспариваемого дела.</p>
        ...
        <p>11.2. Если какое-либо положение настоящего Соглашения будет признано судом или другим органом компетентной юрисдикции недействительным, незаконным или не имеющим законной силы по какой-либо причине, такое положение должно быть отменено или ограничено в минимальной степени таким образом, чтобы остальные положения Соглашения сохранялись в полной силе и эффективности.</p>
    </div>
    <footer class="page-footer page-footer--politics container">
        <a href="<?= $path; ?>index.php">
            <svg width="98" height="67">
                <use xlink:href="<?= $path; ?>/img/sprite.svg#logo"></use>
            </svg>
        </a>
        <p class="page-footer__year">Сopyright – all rights reserved 2023</p>
        <div class="page-footer__wrapper">
            <a href="<?= $path; ?>politics.php" class="page-footer__polycy">Политика конфиденциальности</a>
            <a class="active" href="<?= $path; ?>conditions.php" class="page-footer__polycy">Пользовательское соглашение</a>
        </div>
    </footer>
    <script src="js/scriptForPolitics.js"></script>
</body>
