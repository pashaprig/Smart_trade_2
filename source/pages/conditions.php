...
<head>
    ...
    <title>BlackRock Invest</title>
    <meta name="description" content="Подключайтесь к инвестиционному проекту BlackRock Invest и зарабатывайте от 4 000 € ежемесячно!">
...
<body class="page-body page-body--politics container">
    ...
    <a href="index.php">
        ...
        <nav class="main-nav main-nav--closed main-nav--nojs">
            <ul class="main-nav__list">
                ...
                <li class="main-nav__item"><a href="index.php#video">Презентация</a></li>
                <li class="main-nav__item"><a href="index.php#partners">Партнёры</a></li>
                <li class="main-nav__item"><a href="index.php#about">О проекте</a></li>
                <li class="main-nav__item"><a href="index.php#investment">Инвестирование</a></li>
            </ul><a class="btn" href="index.php#leadform1">Зарегистрироваться</a> <button class="main-nav__toggle" type="button"><span class="main-nav__open-btn-text visually-hidden">Mеню</span></button>
        </nav>
    </header>
    <hr>
    <div class="legal-content">
        ...
        <p>Настоящее Клиентское соглашение (в дальнейшем именуемое «Соглашение») заключается между вами и Meta, компания с номером 2020-00035, зарегистрированным домом Rodney Bayside, Rodney Bay, Gros-Islet, Сент-Люсия, частной компанией с ограниченной ответственностью, созданной и существующей в соответствии с законами Сент-Люсии («Компания», «мы» или «нас»).</p>

        <p>Настоящее Соглашение регулирует использование услуг, предоставляемых через Веб-сайт Meta (далее именуемый «Веб-сайт»), которым управляет Meta («Услуги» или «Сервис»).</p>
        ...
        <p><b>Компания</b> - Meta (зарегистрированный номер: 2020-00035), Родни Бэйсайд Билдинг, Родни Бэй, Грос-Айлет, Сент-Люсия.</p>
    ...
    <footer class="page-footer page-footer--politics container">
        ...
        <div class="page-footer__wrapper">
            <a href="?page=politics" class="page-footer__polycy">Политика конфиденциальности</a>
            <a class="active" href="?page=conditions" class="page-footer__polycy">Пользовательское соглашение</a>
        </div>
    </footer>
