...
<body class="page-body page-body--politics container">
    ...
    Meta, номер компании 2020-00035, зарегистрирована по адресу Rodney Bayside, Rodney Bay, Gros-Islet, Сент-Люсия («Компания»; «мы»; «мы»; «наши») и ее филиалы уважают вашу конфиденциальность и ценят ее важность и полностью привержены обеспечению безопасности и защиты вашей информации.
    ...
    Полное наименование юридического лица: Meta<br>
    ...
    <footer class="page-footer page-footer--politics container">
        ...
        <div class="page-footer__wrapper">
            <a class="active" href="?page=politics" class="page-footer__polycy">Политика конфиденциальности</a>
            <a href="?page=conditions" class="page-footer__polycy">Пользовательское соглашение</a>
        </div>
    </footer>
